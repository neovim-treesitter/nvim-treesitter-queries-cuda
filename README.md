# nvim-treesitter-queries-cuda

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-cuda/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-cuda/actions/workflows/validate.yml)

Neovim tree-sitter queries for **cuda**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-cuda",
...
- [ ] Changes are scoped to `cuda` — do not include files for other languages
